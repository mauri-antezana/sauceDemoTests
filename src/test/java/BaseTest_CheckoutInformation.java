...
public class BaseTest_CheckoutInformation {
    WebDriver driver;
    ...
    public void setup(){
        ...
        WebElement addToCartButton_1 = driver.findElement(By.xpath("//*[@id=\"inventory_container\"]/div/div[1]/div[3]/button"));
        WebElement addToCartButton_2 = driver.findElement(By.xpath("//*[@id=\"inventory_container\"]/div/div[2]/div[3]/button"));
